                    ...
                    <div className="row">
                        ...
                        <div class="col">
                            ...
                            <div className="d-flex justify-content-center">
                                <div className="div-log text-big big d-inline-flex">O naszym sklepie <Image className="logo logo-size" src={`/Shop_GOOD_Clothes/Shop_GOOD_Clothes/image/logo.png`} /></div>
                            </div>
                            ...
                            <div className="d-flex justify-content-center">
                            <img src={`/Shop_GOOD_Clothes/Shop_GOOD_Clothes/image/cafe-3537801_640.jpg`} class="mw-100" alt="shop" />
                            </div>
                            ...
                            <div className="d-flex justify-content-center">
                                <img src={`/Shop_GOOD_Clothes/Shop_GOOD_Clothes/image/port-8431044_640.jpg`} class="mw-100" alt="shop-img" />
                            </div>
